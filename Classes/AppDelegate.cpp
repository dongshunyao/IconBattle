...
static cocos2d::Size smallResolutionSize = cocos2d::Size(1200, 900);
static cocos2d::Size mediumResolutionSize = cocos2d::Size(1200, 900);
static cocos2d::Size largeResolutionSize = cocos2d::Size(1200, 900);
...
bool AppDelegate::applicationDidFinishLaunching()
{
	...
	if (!glview)
	{
		...
		glview = GLViewImpl::createWithRect("IconBattle",
		                                    cocos2d::Rect(0, 0, designResolutionSize.width,
		                                                  designResolutionSize.height));
#else
        glview = GLViewImpl::create("IconBattle");
#endif
		director->setOpenGLView(glview);
	}

	// TODO turn off display FPS
